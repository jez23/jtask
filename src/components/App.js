      ...
      <div className="mainContainer">
       { sideBarState &&
         <SideNav 
              ...
              setSideNavUserState={setSideNavUserState}
        ...
        <Dashboard
          ...
          newTicketFunction={newTicketFunction}
          viewTicketFunction={viewTicketFunction}
          viewTicketModal={viewTicketModal}
          newTicketModal={newTicketModal}
          editModal={editModal}
          sideNavUserState={sideNavUserState}
          setSideNavUserState={setSideNavUserState}
...
const tickets = [
  ...
  },
  {
    ...
    comments: [
      { userName: "Mark",
        comment: "Have this ticket been approved?"
      },
      { userName: "Emily",
